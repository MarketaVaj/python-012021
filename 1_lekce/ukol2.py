...
soucastka = input('Napis cislo soucastky:')
if soucastka in sklad:
  mnozstvisoucastek: str = input('Kolik soucastek si chces koupit?')
  if int(mnozstvisoucastek) <= sklad[soucastka]:
    print('Mame dostatecne mnozstvi soucastek.')
    sklad[soucastka] -= int(mnozstvisoucastek)
  else:
    print('Nemame dostatecne mnozstvi soucastky. Muzeme prodat pouze',sklad[soucastka], 'kusu.')
    sklad.pop(soucastka)
else:
