...
hodina = int(input('Pro jakou hodinu si prejete yamlivut meeting room?'))
if hodina in volnePokoje:
    print('Volne meeting room jsou', len(volnePokoje[hodina]),'.')
else:
    print('Neni volny zadny meeting room.')