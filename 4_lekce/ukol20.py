...
balikjedna = Balik(generator_falesnych_dat.name(),generator_falesnych_dat.address())
print(balikjedna.get_info())

#Po přidání třídy balík se mně printen zobrazuje ještě None a netuším proč. Ale připravím si to jako dotaz na pondělní konzultace.
